...
import TrialListClient from '@/components/TrialListClient';
...
export default async function SubjectPage({
  ...
  const basePath = `/${typedTrack}/${typedGrade}/${typedSubject}`;
    ...
    <div>
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <nav className="mb-8 text-sm text-gray-500">
          ...
          <span className="mx-2">/</span>
          <TeacherLink href={`/${typedTrack}/${typedGrade}`} className="hover:text-gray-700 transition-colors">
            {gradeLabel}
          </TeacherLink>
          <span className="mx-2">/</span>
